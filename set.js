...
global.caption = "*©𝟐𝟎𝟐𝟒 𝐔𝐒𝐇𝐀𝐍 𝐌𝐃 𝐕𝟓*"; // Input Yours custom...(Maintain font for Flow)
...
module.exports = {
SESSION_ID: process.env.SESSION_ID || "Gifted~vyBlWIxI#bKNemIMuU4Hwvum3YhDSVqq9S2ueR1qlNYzYwOAh_-E", // Add sess Id here espwcially when deploying on panels else use app.json and .env file...
...
OWNER_NUMBER: process.env.OWNER_NUMBER || "94775942312", // Only 1 owner Number Here, others Add to sudo numbers...
OWNER_NAME: process.env.OWNER_NAME || "𝐔𝐒𝐇𝐀𝐍-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
PACK_AUTHOR: process.env.PACK_AUTHOR || "𝐔𝐒𝐇𝐀𝐍-𝐌𝐃", // Added // Input Yours custom...
PACK_NAME: process.env.PACK_NAME || "𝐔𝐒𝐇𝐀𝐍-𝐌𝐃 💗", // Added // Input Yours custom...
PREFIX: process.env.PREFIX || "*",
API_KEY: process.env.API_KEY || "Ushan-md", // Replace with your unlimited api key
...
ANTICALL_MSG: process.env.ANTICALL_MSG || "*_📞 Auto Call Reject Mode Activated by Ushan-MD. 📵 No Calls Allowed Dude!_*",
AUTO_REACT: process.env.AUTO_REACT || "false",
BOT_NAME: process.env.BOT_NAME || "𝐔𝐒𝐇𝐀𝐍-𝐌𝐃", // Input Yours custom...(Maintain font for Flow)
BOT_PIC: process.env.BOT_PIC || "https://i.ibb.co/17WmY2L/9730891ece48c5d7.jpg", // You can Replace with yours...
